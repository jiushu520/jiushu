const  线性代数04内外积与正切=[
{equation: "\\begin{gather}直角坐标系中有两点A(1,4)、B(-8,-10)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(1,4)\\otimes(-8,-10)}{(1,4)\\cdot(-8,-10)}\\\\ (1+4i)(-8+10i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{11}{24}",incorrectOptions:["\\frac{8}{7}","-\\frac{4}{5}","0"]},

{equation: "\\begin{gather}直角坐标系中有两点A(0,7)、B(-4,-2)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(0,7)\\otimes(-4,-2)}{(0,7)\\cdot(-4,-2)}\\\\ (0+7i)(-4+2i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-2",incorrectOptions:["\\frac{1}{7}","\\frac{5}{2}","-\\frac{7}{8}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-8,5)、B(2,-5)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-8,5)\\otimes(2,-5)}{(-8,5)\\cdot(2,-5)}\\\\ (-8+5i)(2+5i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{30}{41}",incorrectOptions:["-3","\\frac{1}{3}","-2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(2,-6)、B(2,1)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(2,-6)\\otimes(2,1)}{(2,-6)\\cdot(2,1)}\\\\ (2-6i)(2-i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-7",incorrectOptions:["\\frac{1}{2}","\\frac{2}{3}","-\\frac{5}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-2,-2)、B(0,3)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-2,-2)\\otimes(0,3)}{(-2,-2)\\cdot(0,3)}\\\\ (-2-2i)(0-3i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-1",incorrectOptions:["-\\frac{8}{5}","\\frac{1}{4}","-\\frac{7}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(0,-5)、B(-6,-8)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(0,-5)\\otimes(-6,-8)}{(0,-5)\\cdot(-6,-8)}\\\\ (0-5i)(-6+8i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{3}{4}",incorrectOptions:["-\\frac{1}{5}","-\\frac{2}{3}","-7"]},

{equation: "\\begin{gather}直角坐标系中有两点A(4,-7)、B(-1,7)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(4,-7)\\otimes(-1,7)}{(4,-7)\\cdot(-1,7)}\\\\ (4-7i)(-1-7i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{21}{53}",incorrectOptions:["-1","-\\frac{3}{7}","-\\frac{1}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-6,-9)、B(-8,-10)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-6,-9)\\otimes(-8,-10)}{(-6,-9)\\cdot(-8,-10)}\\\\ (-6-9i)(-8+10i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{2}{23}",incorrectOptions:["-\\frac{1}{3}","0","-5"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-10,-5)、B(-7,1)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-10,-5)\\otimes(-7,1)}{(-10,-5)\\cdot(-7,1)}\\\\ (-10-5i)(-7-i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{9}{13}",incorrectOptions:["1","\\frac{1}{2}","4"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,8)、B(-2,0)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(3,8)\\otimes(-2,0)}{(3,8)\\cdot(-2,0)}\\\\ (3+8i)(-2=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{8}{3}",incorrectOptions:["-\\frac{7}{4}","-\\frac{3}{2}","-\\frac{1}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(6,3)、B(5,3)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(6,3)\\otimes(5,3)}{(6,3)\\cdot(5,3)}\\\\ (6+3i)(5-3i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{1}{13}",incorrectOptions:["\\frac{4}{5}","-\\frac{1}{10}","-\\frac{1}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(4,-3)、B(1,-6)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(4,-3)\\otimes(1,-6)}{(4,-3)\\cdot(1,-6)}\\\\ (4-3i)(1+6i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{21}{22}",incorrectOptions:["-\\frac{4}{5}","\\frac{4}{5}","-\\frac{1}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,-4)、B(-10,-9)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(3,-4)\\otimes(-10,-9)}{(3,-4)\\cdot(-10,-9)}\\\\ (3-4i)(-10+9i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{67}{6}",incorrectOptions:["-\\frac{7}{9}","-\\frac{4}{3}","2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(5,2)、B(-5,-8)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(5,2)\\otimes(-5,-8)}{(5,2)\\cdot(-5,-8)}\\\\ (5+2i)(-5+8i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{30}{41}",incorrectOptions:["-\\frac{7}{6}","\\frac{8}{7}","-4"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,4)、B(3,-7)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(3,4)\\otimes(3,-7)}{(3,4)\\cdot(3,-7)}\\\\ (3+4i)(3+7i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{33}{19}",incorrectOptions:["1","\\frac{9}{7}","-1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-2,-2)、B(0,8)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-2,-2)\\otimes(0,8)}{(-2,-2)\\cdot(0,8)}\\\\ (-2-2i)(0-8i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-1",incorrectOptions:["-\\frac{3}{2}","\\frac{5}{2}","\\frac{1}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(1,-7)、B(4,-2)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(1,-7)\\otimes(4,-2)}{(1,-7)\\cdot(4,-2)}\\\\ (1-7i)(4+2i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{13}{9}",incorrectOptions:["-\\frac{2}{3}","-\\frac{7}{8}","\\frac{5}{9}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(8,-10)、B(4,-6)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(8,-10)\\otimes(4,-6)}{(8,-10)\\cdot(4,-6)}\\\\ (8-10i)(4+6i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{2}{23}",incorrectOptions:["\\frac{8}{3}","\\frac{1}{2}","\\frac{5}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-6,0)、B(-2,0)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-6,0)\\otimes(-2,0)}{(-6,0)\\cdot(-2,0)}\\\\ (-6(-2=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "0",incorrectOptions:["\\frac{8}{5}","2","-2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-7,-1)、B(-3,-9)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-7,-1)\\otimes(-3,-9)}{(-7,-1)\\cdot(-3,-9)}\\\\ (-7-i)(-3+9i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "2",incorrectOptions:["-\\frac{10}{7}","3","\\frac{1}{10}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-7,-8)、B(3,7)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-7,-8)\\otimes(3,7)}{(-7,-8)\\cdot(3,7)}\\\\ (-7-8i)(3-7i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{25}{77}",incorrectOptions:["-\\frac{1}{4}","\\frac{8}{3}","\\frac{4}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(8,2)、B(8,-4)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(8,2)\\otimes(8,-4)}{(8,2)\\cdot(8,-4)}\\\\ (8+2i)(8+4i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{6}{7}",incorrectOptions:["\\frac{1}{6}","1","0"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-4,-3)、B(1,-8)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-4,-3)\\otimes(1,-8)}{(-4,-3)\\cdot(1,-8)}\\\\ (-4-3i)(1+8i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{7}{4}",incorrectOptions:["-\\frac{8}{7}","-1","0"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-3,-2)、B(-9,1)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-3,-2)\\otimes(-9,1)}{(-3,-2)\\cdot(-9,1)}\\\\ (-3-2i)(-9-i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{21}{25}",incorrectOptions:["-3","1","\\frac{1}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-3,8)、B(-2,7)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-3,8)\\otimes(-2,7)}{(-3,8)\\cdot(-2,7)}\\\\ (-3+8i)(-2-7i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{5}{62}",incorrectOptions:["1","-\\frac{3}{2}","-\\frac{1}{4}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(4,4)、B(-10,-4)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(4,4)\\otimes(-10,-4)}{(4,4)\\cdot(-10,-4)}\\\\ (4+4i)(-10+4i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{3}{7}",incorrectOptions:["\\frac{1}{4}","\\frac{5}{7}","2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-3,-5)、B(-9,1)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-3,-5)\\otimes(-9,1)}{(-3,-5)\\cdot(-9,1)}\\\\ (-3-5i)(-9-i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{24}{11}",incorrectOptions:["1","-\\frac{5}{3}","-\\frac{1}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-4,2)、B(3,-9)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(-4,2)\\otimes(3,-9)}{(-4,2)\\cdot(3,-9)}\\\\ (-4+2i)(3+9i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-1",incorrectOptions:["-\\frac{8}{7}","-\\frac{4}{5}","\\frac{1}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,2)、B(0,-4)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(3,2)\\otimes(0,-4)}{(3,2)\\cdot(0,-4)}\\\\ (3+2i)(0+4i)=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "-\\frac{3}{2}",incorrectOptions:["\\frac{3}{5}","\\frac{3}{7}","\\frac{6}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(8,-1)、B(5,0)\\textup{;}\\\\则tan∠AOB=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\\\ tan∠AOB=\\frac{(8,-1)\\otimes(5,0)}{(8,-1)\\cdot(5,0)}\\\\ (8-i)(5=? \\\\向量法,复数法,解析法,面积法(有推导才有用)...... \\end{gather}",correctOption: "\\frac{1}{8}",incorrectOptions:["0","\\frac{6}{7}","-\\frac{1}{4}"]},
