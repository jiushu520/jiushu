...
const 自招真题07圆与三角函数=[
{equation: "\\begin{gather}1.如图,AB 是半圆的直径,\\\\点 C 是\\overset{\\frown}{AB} 的中点,点 D 是\\overset{\\frown}{AC} 的中点,\\\\连接 AC、BD 交于点 E,则\\frac{DE}{BE}=？\\\\提示标签：角平分线、单位圆、倍半角、托勒密、\\\\圆幂定理、相似、点到直线距离......\\end{gather}",img: "images/zz08circle001.png",correctOption: "\\frac{\\sqrt{2}-1}{2}",incorrectOptions:["\\frac{1}{5}","\\frac{3}{16}","1-\\frac{\\sqrt{2}}{2}"]},

{equation: "\\begin{gather}2.如图,AB 是半圆O的直径,\\\\点 D 是\\overset{\\frown}{BC} 的中点,OD 交弦BC于点E,\\\\若BC=8,DE=2,则\\tan∠BAE=？\\\\提示标签：12345、角平分线、单位圆、倍半角、托勒密、\\\\圆幂定理、相似、射影定理......\\end{gather}",img: "images/zz08circle002.png",correctOption: "\\frac{6}{17}",incorrectOptions:["\\frac{4}{11}","\\frac{3}{16}","\\frac{9}{25}"]},



{equation: "\\begin{gather}3.如图，⊙O 的直径 AB 的长为 10，弦 AC 长为 6，∠ACB 的平分线交⊙O 于 D，则 CD =？\\\\提示标签：12345、角平分线、单位圆、倍半角、射影定理\\\\正余弦定理、圆幂定理、相似......\\end{gather}",img: "images/zz08circle003.png",correctOption: "7\\sqrt{2}",incorrectOptions:["8\\sqrt{2}","7","8"]},


{equation: "\\begin{gather}4.如图，已知 BE 是△ABC 的外接圆的直径，CD⊥AB于D．若AD=3，BD=8，CD=6，则 BE=?\\\\提示标签：12345、单位圆、托勒密、射影定理\\\\正余弦定理、圆幂定理、相似......\\end{gather}",img: "images/zz08circle004.png",correctOption: "5\\sqrt{5}",incorrectOptions:["8\\sqrt{2}","12","\\frac{45}{4}"]},
...
const 燕尾模型05两内比的应用=[
{equation: "\\begin{gather}如图，三角形ABC中，AO:OD=2:1，BO:OE=5:1，\\\\S△ABO=30平方厘米，S△OCE=4平方厘米。\\\\则S△DCO为多少平方厘米？\\end{gather}", img: "images/052404001.png",correctOption:"5 ",incorrectOptions:["9","6","2",]},
{equation: "\\begin{gather}如图，三角形ABC中，AO:OD=2:1，BO:OE=5:1，\\\\S△ABO=60平方厘米，S△OCE=8平方厘米。\\\\则S△DCO为多少平方厘米？\\end{gather}", img: "images/052404002.png",correctOption:"10 ",incorrectOptions:["8","3","14",]},
{equation: "\\begin{gather}如图，三角形ABC中，AO:OD=2:1，BO:OE=5:1，\\\\S△ABO=90平方厘米，S△OCE=12平方厘米。\\\\则S△DCO为多少平方厘米？\\end{gather}", img: "images/052404003.png",correctOption:"15 ",incorrectOptions:["7","29","13",]},
{equation: "\\begin{gather}如图，三角形ABC中，AO:OD=2:1，BO:OE=5:1，\\\\S△ABO=30平方厘米。\\\\设S△CEO=x平方厘米，S△DCO=y平方厘米，\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404004.png",correctOption:"9 ",incorrectOptions:["12","18","21",]},
{equation: "\\begin{gather}如图，三角形ABC中，AO:OD=2:1，BO:OE=5:1，\\\\S△ABO=60平方厘米。\\\\设S△CEO=x平方厘米，S△DCO=y平方厘米，\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404005.png",correctOption:"18 ",incorrectOptions:["12","9","30",]},
{equation: "\\begin{gather}如图，三角形ABC中，AO:OD=2:1，BO:OE=5:1，\\\\S△ABO=90平方厘米。\\\\设S△CEO=x平方厘米，S△DCO=y平方厘米，\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404006.png",correctOption:"27 ",incorrectOptions:["20","12","16",]},
{equation: " \\begin{gather}如图，三角形ABC中，BO:OE=1:1，AO:OD=2:1，\\\\S△ABO=10平方厘米。\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404007.png",correctOption:"35 ",incorrectOptions:["23","26","19",]},
{equation: " \\begin{gather}如图，三角形ABC中，BO:OE=1:1，AO:OD=2:1，\\\\S△ABO=20平方厘米。\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404008.png",correctOption:"70 ",incorrectOptions:["50","80","63",]},
{equation: "\\begin{gather}如图，三角形ABC中，BO:OE=1:1，AO:OD=2:1，\\\\S△ABO=8平方厘米。\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404009.png",correctOption:"28 ",incorrectOptions:["50","48","54",]},
{equation: "\\begin{gather}如图，三角形ABC中，BO:OE=1:1，AO:OD=3:1，\\\\S△ABC=24平方厘米。\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404010.png",correctOption:"10 ",incorrectOptions:["12","9","8",]},
{equation: "\\begin{gather}如图，三角形ABC中，BO:OE=1:1，AO:OD=3:1，\\\\S△ABC=36平方厘米。\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404011.png",correctOption:"15 ",incorrectOptions:["24","26","37",]},
{equation: " \\begin{gather}如图，三角形ABC中，BO:OE=1:1，AO:OD=3:1，\\\\S△ABC=48平方厘米。\\\\则S四边形DCEO为多少平方厘米？\\end{gather}", img: "images/052404012.png",correctOption:"20 ",incorrectOptions:["32","37","25",]},
]
