const 直角坐标系运算01两点距离 = [
 {equation: "\\begin{gather}直角坐标系中有两点A(-5,4)、B(8,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{7}{13}",incorrectOptions:["-8","\\frac{1}{4}","\\frac{8}{9}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-7,4)、B(-5,1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{3}{2}",incorrectOptions:["\\frac{7}{3}","2","-\\frac{6}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(1,-1)、B(0,3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-4",incorrectOptions:["-\\frac{1}{9}","\\frac{2}{5}","\\frac{9}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-9,5)、B(-1,-7)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{3}{2}",incorrectOptions:["-\\frac{1}{3}","-\\frac{1}{2}","-\\frac{2}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-7,6)、B(-10,0)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "2",incorrectOptions:["-1","1","-\\frac{1}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-10,-7)、B(-5,-1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{6}{5}",incorrectOptions:["\\frac{7}{8}","0","-\\frac{1}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-1,3)、B(4,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{13}{5}",incorrectOptions:["4","-1","\\frac{5}{8}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-3,-10)、B(-1,-8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "1",incorrectOptions:["\\frac{1}{2}","\\frac{6}{5}","-2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-9,-1)、B(3,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{3}{4}",incorrectOptions:["-2","-\\frac{1}{6}","\\frac{4}{9}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-8,-2)、B(8,-4)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{1}{8}",incorrectOptions:["2","\\frac{8}{5}","-\\frac{6}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(6,-5)、B(-9,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{2}{15}",incorrectOptions:["-\\frac{8}{5}","-\\frac{5}{2}","\\frac{2}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(1,-10)、B(2,1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "11",incorrectOptions:["\\frac{2}{3}","-\\frac{2}{3}","\\frac{1}{10}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-8,-8)、B(-10,-5)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{3}{2}",incorrectOptions:["-\\frac{3}{4}","-\\frac{7}{4}","\\frac{1}{4}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-2,-6)、B(-1,3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "9",incorrectOptions:["-\\frac{5}{7}","\\frac{5}{4}","-\\frac{2}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-9,-9)、B(-6,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{1}{3}",incorrectOptions:["\\frac{5}{8}","\\frac{5}{9}","1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-6,-9)、B(5,6)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{15}{11}",incorrectOptions:["\\frac{5}{2}","-2","2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(1,1)、B(3,8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{7}{2}",incorrectOptions:["\\frac{3}{4}","-10","2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(0,2)、B(-3,6)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{4}{3}",incorrectOptions:["-\\frac{1}{6}","-\\frac{1}{2}","-1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-3,-9)、B(-10,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{6}{7}",incorrectOptions:["\\frac{1}{2}","\\frac{4}{5}","\\frac{2}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,1)、B(6,1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "0",incorrectOptions:["3","\\frac{7}{9}","-\\frac{1}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-10,-6)、B(-2,-2)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{1}{2}",incorrectOptions:["0","\\frac{5}{6}","\\frac{3}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-4,-8)、B(-10,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{1}{3}",incorrectOptions:["4","-\\frac{2}{7}","2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-2,8)、B(5,-4)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{12}{7}",incorrectOptions:["\\frac{7}{5}","\\frac{1}{4}","\\frac{5}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(6,-9)、B(8,0)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{9}{2}",incorrectOptions:["\\frac{7}{9}","-\\frac{7}{4}","3"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-4,-10)、B(-3,-8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "2",incorrectOptions:["0","\\frac{7}{3}","-\\frac{8}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(0,4)、B(4,1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{3}{4}",incorrectOptions:["5","-\\frac{3}{7}","\\frac{1}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(4,-4)、B(-5,-2)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{2}{9}",incorrectOptions:["-\\frac{1}{9}","\\frac{4}{5}","-\\frac{1}{9}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-5,-2)、B(-6,-7)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "5",incorrectOptions:["-4","\\frac{3}{4}","-\\frac{3}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-1,-10)、B(-10,2)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{4}{3}",incorrectOptions:["10","-\\frac{4}{9}","-\\frac{4}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(0,-3)、B(8,1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{1}{2}",incorrectOptions:["\\frac{9}{5}","-1","\\frac{3}{2}"]},
...
{equation: "\\begin{gather}直角坐标系中有两点A(3,-1)、B(-4,-5)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{4}{7}",incorrectOptions:["2","-4","-\\frac{2}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-4,-3)、B(-6,8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{11}{2}",incorrectOptions:["\\frac{6}{7}","\\frac{8}{7}","\\frac{7}{6}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(8,-5)、B(-3,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{5}{11}",incorrectOptions:["-\\frac{2}{7}","-\\frac{1}{5}","\\frac{3}{4}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-9,-4)、B(5,-4)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "0",incorrectOptions:["-\\frac{5}{2}","\\frac{5}{3}","\\frac{8}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-4,2)、B(4,-2)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{1}{2}",incorrectOptions:["\\frac{10}{3}","\\frac{3}{8}","\\frac{2}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,-1)、B(-7,8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{9}{10}",incorrectOptions:["\\frac{1}{4}","-7","-\\frac{6}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(5,-2)、B(-2,-4)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{2}{7}",incorrectOptions:["-\\frac{3}{4}","\\frac{1}{2}","-\\frac{3}{8}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-6,3)、B(5,2)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{1}{11}",incorrectOptions:["-5","-\\frac{1}{7}","1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,3)、B(-5,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{3}{4}",incorrectOptions:["\\frac{2}{7}","-\\frac{1}{6}","-\\frac{1}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-8,-2)、B(5,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{1}{13}",incorrectOptions:["\\frac{3}{4}","-\\frac{3}{5}","\\frac{5}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-9,-3)、B(3,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{7}{12}",incorrectOptions:["\\frac{4}{9}","\\frac{4}{5}","2"]},

{equation: "\\begin{gather}直角坐标系中有两点A(7,-4)、B(-7,-5)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{1}{14}",incorrectOptions:["-\\frac{3}{2}","-\\frac{7}{5}","-1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(1,-8)、B(-3,6)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{7}{2}",incorrectOptions:["\\frac{5}{4}","0","-8"]},

{equation: "\\begin{gather}直角坐标系中有两点A(3,4)、B(-3,-8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "2",incorrectOptions:["-\\frac{5}{6}","2","\\frac{4}{3}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(6,-2)、B(-4,1)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{3}{10}",incorrectOptions:["\\frac{2}{7}","-2","-\\frac{5}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(6,-8)、B(8,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-1",incorrectOptions:["-\\frac{1}{2}","1","-\\frac{8}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(7,2)、B(-3,-10)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{6}{5}",incorrectOptions:["6","\\frac{10}{9}","\\frac{7}{4}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(2,1)、B(-3,-7)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{8}{5}",incorrectOptions:["-1","8","1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-8,-5)、B(-10,3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-4",incorrectOptions:["-\\frac{8}{9}","-\\frac{1}{4}","\\frac{1}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(-8,-8)、B(7,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{1}{3}",incorrectOptions:["-2","\\frac{1}{2}","\\frac{7}{5}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(4,3)、B(-10,-3)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{3}{7}",incorrectOptions:["-\\frac{8}{7}","0","\\frac{1}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(6,7)、B(-2,-7)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{7}{4}",incorrectOptions:["\\frac{3}{5}","\\frac{9}{2}","-\\frac{3}{8}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(5,-10)、B(6,-2)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "8",incorrectOptions:["\\frac{1}{2}","9","\\frac{3}{2}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(4,-2)、B(1,8)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{10}{3}",incorrectOptions:["0","-\\frac{5}{8}","1"]},

{equation: "\\begin{gather}直角坐标系中有两点A(8,-1)、B(2,-5)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "\\frac{2}{3}",incorrectOptions:["\\frac{7}{8}","-\\frac{6}{7}","\\frac{4}{7}"]},

{equation: "\\begin{gather}直角坐标系中有两点A(0,-7)、B(-7,-6)\\textup{;}\\\\则直线AB的斜率=\\textup{?}\\\\画出直角坐标系及相关点线再计算。\\end{gather}",correctOption: "-\\frac{1}{7}",incorrectOptions:["-\\frac{2}{3}","\\frac{4}{3}","-4"]},
